...
/**
  ...
  * @var \App\Model\Entity\Modem[]|\Cake\Collection\CollectionInterface $modems
  */
?>
...
<div class="modems index large-9 medium-8 columns content">
    <h3><?= __('Modems') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $modem->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $modem->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $modem->id], ['confirm' => __('Are you sure you want to delete # {0}?', $modem->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
